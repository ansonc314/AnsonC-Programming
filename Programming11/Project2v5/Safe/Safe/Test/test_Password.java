...
public class test_Password {
    ...
    public void mytest_lengthcheck() throws IOException {
        ...
        password.set_Password("1234567");   // password with length < 8, failing length test
        boolean value = password.length_check();
        assertEquals(value,false);

        password.set_Password("12345678");   // password with length >= 8 and length test is passed
    ...
    @Test  // this test the character_check function: password uses only lower case char.
