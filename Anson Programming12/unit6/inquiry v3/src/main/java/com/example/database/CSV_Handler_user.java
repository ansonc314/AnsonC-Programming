...
public class CSV_Handler_user {
    ...
    public HashMap_Handler_user CSV2RecordSet()   throws IOException {
        ...
        CSVParser csvParser = new CSVParser(reader, CSVFormat.DEFAULT
                .withHeader(RecordInfo.header_user[0],  RecordInfo.header_user[1],  RecordInfo.header_user[2],  RecordInfo.header_user[3])
        ...
        for (CSVRecord csvRecord : csvParser) {
            ...
            String entry3 = csvRecord.get(RecordInfo.header_user[3]);
    ...
    public void RecordSet2CSV(HashMap_Handler_user input) throws IOException {
        ...
        csvPrinter.printRecord(RecordInfo.header_user[0],RecordInfo.header_user[1],RecordInfo.header_user[2],RecordInfo.header_user[3]);
