...
public class DerbyTable_Handler {
     ...
     */
    public DerbyTable_Handler(DerbyDatabase_Handler handler){
     ...
     * table_name is defined in the class SystemInfo
     */
    public DerbyTable_Handler(DerbyDatabase_Handler handler, String tableName){
        this.handler = handler;
     ...
     */
    public void RecordSet2Derby(RecordSet_Handler input){
     ...
     */
    public RecordSet_Handler Derby2RecordSet()  {
